...
function Navbar() {
  ...
  return (
    <div className="w-full chacha fixed top-0 left-0 bg-transparent z-50">
      <div className="w-full h-20 p-2 flex justify-center items-center text-black bg-white bg-opacity-50 backdrop-blur-md">
        <div className="w-[90%] h-full">
          <div className="w-full h-full flex justify-between items-center relative">
            ...
            <div className="w-[75vw] h-[11vh] bg-[#162479] bg-opacity-90 absolute left-[22%] rounded-tl-[20px] rounded-bl-[80px] hidden lg:block"></div>
            <div className="lg:w-1/2 lg:h-full lg:flex lg:justify-center lg:items-center lg:relative hidden">
              <div ref={navRef} className="w-[50vh] h-full flex justify-center gap-4 lg:gap-8 items-center ml-[-15vw] text-sm lg:text-md text-white relative">
                ...
                <Link to="/pricing" className={`relative ${activeSection === "Services" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`}>
                  ...
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                    initial={{ width: activeSection === "Pricing" ? "100%" : "0%" }}
                    animate={{ width: activeSection === "Pricing" ? "100%" : "0%" }}
                    whileHover={{ width: "100%" }}
                    transition={{ duration: 0.3 }}
                  />
                </Link>
              ...
              <div>
                <div className="flex justify-center items-center gap-4 lg:gap-8 ml-[5vw]">
                  <button className="border-2 border-white text-white px-3 py-2 lg:px-5 lg:py-3 rounded-full text-sm lg:text-base font-semibold bttn1" onClick={handlePhoneCall}>
                    8650589386
                  </button>
                  <button
                    className="bg-yellow-400 border-2 border-white text-black px-3 py-2 lg:px-5 lg:py-3 rounded-full text-sm lg:text-base font-bold"
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-[#162479] bg-opacity-90 text-white">
          <div className="flex flex-col items-center py-4">
            <Link to="/" className={`py-2 relative ${activeSection === "Home" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`} onClick={() => { setActiveSection("Home"); setIsMenuOpen(false); }}>
              Home
              <motion.div
                className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                initial={{ width: activeSection === "Home" ? "100%" : "0%" }}
            ...
            <Link to="/about" className={`py-2 relative ${activeSection === "About" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`} onClick={() => { setActiveSection("About"); setIsMenuOpen(false); }}>
              About
              <motion.div
                className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                initial={{ width: activeSection === "About" ? "100%" : "0%" }}
            ...
            <Link to="/services" className={`py-2 relative ${activeSection === "Services" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`} onClick={() => { setActiveSection("Services"); setIsMenuOpen(false); }}>
              Pricing
              <motion.div
                className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                initial={{ width: activeSection === "Pricing" ? "100%" : "0%" }}
            ...
            <Link to="/contact" className={`py-2 relative ${activeSection === "Contact" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`} onClick={() => { setActiveSection("Contact"); setIsMenuOpen(false); }}>
              Contact
              <motion.div
                className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                initial={{ width: activeSection === "Contact" ? "100%" : "0%" }}
            ...
            <button className="border-2 bttn1 border-white text-white px-4 py-2 rounded-full my-2 hover:bg-white hover:text-[#162479] transition-colors duration-300" onClick={handlePhoneCall}>
              8650589386
            </button>
            <button
