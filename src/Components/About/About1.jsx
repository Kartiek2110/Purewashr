    ...
    <section ref={ref} className="py-16 p-10 w-full bg-gray-100">
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-blue-600 font-semibold mb-2 text-base"
          >
        ...
        <div className="flex flex-wrap items-center -mx-4">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                variants={itemVariants}
                className="absolute bottom-0 left-0 right-0 bg-white p-4 m-4 rounded-lg shadow-md flex items-center"
              >
                <img
                  alt="Phone icon"
                ...
                <div>
                  ...
                  <a
                    href="tel:+1234567890"
                    className="text-lg font-bold text-blue-600 hover:text-blue-800 transition duration-300"
                  >
                    8650589386
                  </a>
                </div>
