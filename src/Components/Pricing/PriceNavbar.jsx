...
function PriceNavbar() {
  ...
  const [activeSection] = useState("Pricing");
  ...
  return (
    <div className="w-full fixed top-0 left-0 bg-transparent z-50">
          ...
          <div className="w-full h-full flex justify-between items-center relative">
            ...
            <div className="md:w-1/2 md:h-full md:flex md:justify-center md:items-center md:relative hidden">
              <div ref={navRef} className="w-[50vh] h-full flex justify-center gap-8 items-center ml-[-15vw] text-md text-white relative">
                ...
                <Link to="/pricing" className={`relative ${activeSection === "Pricing" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`}>
                  Pricing
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#162479] bg-opacity-90 text-white">
          <div className="flex flex-col items-center py-4">
            ...
            <Link to="/pricing" className={`py-2 relative ${activeSection === "Pricing" ? "font-bold" : ""} hover:text-yellow-400 transition-colors duration-300`} onClick={() => setIsMenuOpen(false)}>
              Pricing
              <motion.div
                className="absolute bottom-0 left-0 w-full h-0.5 bg-white"
                initial={{ width: activeSection === "Pricing" ? "100%" : "0%" }}
